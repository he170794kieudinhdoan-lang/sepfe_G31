      ...
      <div className="container mx-auto px-6 mt-16 mb-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="group bg-white border border-gray-100 rounded-2xl p-6 text-center cursor-pointer hover:shadow-xl hover:border-indigo-100 transition-all duration-300"
            >
              <div className="w-16 h-16 rounded-full bg-gray-50 mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center text-2xl">
                🏢
              </div>
