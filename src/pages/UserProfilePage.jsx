        ...
        <div className='flex flex-col lg:flex-row gap-8'>
          ...
          <aside className='lg:w-56 shrink-0'>
            <nav className='space-y-1'>
              {MENU.map((item) => {
                if (item.key === 'history' && profile?.roleType !== 'WORKER') return null;
          ...
          <main className='flex-1 min-w-0'>
            ...
            {active === 'view' && (
              <Card className='p-6 rounded-xl shadow-sm'>
                ...
                <dl className='grid gap-3 text-sm'>
                  <div><dt className='text-muted-foreground'>Họ tên</dt><dd className='font-medium'>{profile?.fullName || '—'}</dd></div>
              ...
              <Card className='p-6 rounded-xl shadow-sm'>
                ...
                <div className='space-y-4 max-w-sm'>
                  <div>
                    ...
                    <Input className='mt-1 rounded-xl' value={editForm.fullName || ''} onChange={(e) => setEditForm({ ...editForm, fullName: e.target.value })} />
                  </div>
                  <div>
                  ...
                  <Button className='rounded-xl' onClick={handleSaveProfile}>Lưu thay đổi</Button>
                </div>
              </Card>
            )}
            ...
            {active === 'history' && (
              <Card className='p-6 rounded-xl shadow-sm'>
                ...
                <p className='text-muted-foreground text-sm'>Chưa có lịch sử ứng tuyển.</p>
